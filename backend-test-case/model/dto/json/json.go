...
func NewResponseNoContent(c *gin.Context, message, serviceCode, responseCode string) {
	c.JSON(http.StatusNoContent, jsonResponse{
		Code:    "204" + serviceCode + responseCode,
		Message: message,
	})
}
